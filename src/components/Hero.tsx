...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        className="paper-grain pointer-events-none absolute inset-0 opacity-70"
        aria-hidden
      />
      ...
      <div className="container-wide relative grid items-center gap-14 lg:grid-cols-[1.05fr_1fr] lg:gap-10">
        ...
        >
          ...
          >
            {BRAND.name} membuat roti fresh setiap hari dari dapur kecil kami
            bahan pilihan, tanpa pengawet. Setiap gigitan terasa seperti buatan
            rumah.
          </motion.p>
          ...
          >
            ...
            <p className="font-text text-sm font-semibold text-cocoa-700/80">
              <span className="font-extrabold text-cocoa-800">4.9/5</span> dari
