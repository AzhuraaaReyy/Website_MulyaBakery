...
export default function WhyUs() {
  ...
  return (
    ...
    >
      ...
      <TornPaper position="top" fill="#FCF8F0" core="#FFFFFF" seed="why-top" height={76} />
      <TornPaper position="bottom" fill="#F7F0E1" core="#FCF8F0" seed="why-bottom" height={80} />
      ...
      <div className="container-wide relative">
        ...
        <div data-stagger className="mt-16 grid gap-7 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {reasons.map((r, i) => (
            ...
            >
              ...
              <h3 className="font-heading text-xl text-cocoa-800">{r.title}</h3>
              <p className="mt-2.5 font-text text-sm leading-relaxed text-cocoa-700/80">{r.desc}</p>
            </div>
            </div>
          ))}
        </div>
