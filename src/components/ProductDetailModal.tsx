        ...
        {product && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative flex max-h-[92vh] w-full max-w-3xl flex-col overflow-hidden rounded-t-[1.5rem] bg-gradient-to-br from-pink-50 via-paper-100 to-paper-200 shadow-pink-lg sm:max-h-[86vh] sm:rounded-[1.75rem] md:min-h-[380px] md:flex-row"
            >
              {/* Tombol tutup */}
              <button
                type="button"
              ...
              <div className="relative aspect-video w-full shrink-0 bg-cocoa-900 md:aspect-auto md:w-1/2">
                ...
                {product.bestSeller && (
                  <span className="absolute left-3 top-3 inline-flex items-center gap-1 rounded-full bg-cocoa-900/90 px-2.5 py-1 font-text text-[10px] font-extrabold uppercase tracking-wide text-butter backdrop-blur-sm sm:text-xs">
                    <Star className="h-3 w-3 fill-butter" aria-hidden /> Best
                    Seller
                  </span>
                )}
              </div>
              ...
              <div className="flex w-full min-h-0 flex-1 flex-col overflow-y-auto p-6 sm:p-8 md:w-1/2">
                <p className="font-itim text-xs font-bold uppercase tracking-wider text-caramel">
                  {product.category}
                </p>
                ...
                <div className="mt-auto pt-6">
                  <p className="font-itim text-xs uppercase tracking-wider text-cocoa-500/60">
                    Harga
                  </p>
